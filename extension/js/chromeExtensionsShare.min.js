...
a+"&via=");return false}});$("span#share_buzz").click(function(){var a=extensionsShare.getExtensionInfoById($(this).parents(".extension").attr("id"));if(a!=null){var d=" Chrome Extension";if(a.isApp)d=" Chrome App";_gaq.push(["_trackPageview","/extensions/buzz/twitter/"+a.id+"/"+a.name]);window.open("http://www.google.com/buzz/post?message="+encodeURIComponent(a.name+d)+"&imageurl="+encodeURIComponent("https://chrome.google.com/webstore/img/"+a.id+"/2323432/logo128")+"&url="+encodeURIComponent("https://chrome.google.com/webstore/detail/"+
